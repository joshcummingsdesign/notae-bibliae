...
- The <Definition lang="english" anchor="sarum" text="Sarum Rite" />—the local form of the Latin liturgy used at Salisbury Cathedral in southern England from the 11th century until the English Reformation—makes use of the Eight Gregorian Tones. The Sarum Rite is significant because it provides a clear window into the liturgical practices of the English Church before the Reformation.[^14]
