...
<Definition lang="english" anchor="sarum" text="The Sarum Rite" />, or <Definition lang="latin" anchor="usus" text="Use of Sarum" />, was the local form of the Latin liturgy used at Salisbury Cathedral in southern England from the 11th century until the English Reformation. The following rubric shows how the [Eight Gregorian Tones](/glossary/liturgical-terms#the-eight-gregorian-tones) can be applied to the psalms and canticles according to the Sarum Rite.
...
Psalms and [canticles](/glossary/liturgical-terms#canticle) are sung <Definition lang="english" anchor="antiphonal" text="antiphonally" />. The [Precentor](/glossary/liturgical-terms#precentor) sings from the Intonation through to the Mediation. After the Asterisk, the full congregation completes the first verse. The second verse is sung by the [decani](/glossary/liturgical-terms#decani), and the third verse is sung by the [cantoris](/glossary/liturgical-terms#cantoris). Subsequent verses are sung alternately from side to side. If the assembly is smaller, the verses can alternate between the Precentor and the congregation.[^5][^6]
