...
The **Metrum** is applied to the **end of the address** and the **doxology**, and the **Flex** is applied to the **end of the petition** and the **oblation**. In other words, you open and close with the Metrum, and the Flex goes in the middle.[^6]
