...
The **<Red text="Metrum" />** is applied to the **the address** and the **doxology**. The **<Red text="Flex" />** is applied to the **the petition** and the **oblation**. In other words, *you open and close with the Metrum, and the Flex goes in the middle.* If the address is too short or omitted altogether, then apply the Metrum to the petition. Additional Flexes may be added in the middle for longer Collects.[^6]
