...
In the Middle Ages, the "-ed" of past participles was pronounced, a tradition still preserved in Sarum Rite chant today. This syllable is often hyphenated so that singers are not distracted by the frequent need to remember the antique pronunciation.
...
Psalms and [canticles](/glossary/liturgical-terms#canticle) are sung <Definition lang="english" anchor="antiphonal" text="antiphonally" />. The Precentor begins by singing the Intonation and the Mediation. After the Asterisk, the full congregation completes the first verse. The second verse is sung by the [decani](/glossary/liturgical-terms#decani), and the third verse is sung by the [cantoris](/glossary/liturgical-terms#cantoris). Subsequent verses are sung alternately from side to side. If the assembly is smaller, verses can alternate between the Precentor and the congregation.[^4][^5]
...
The **<Red text="Metrum" />** is applied to the **the address** and the **doxology**. The **<Red text="Flex" />** is applied to the **the petition** and the **oblation**. In other words, *you open and close with the Metrum, and the Flex goes in the middle.* If the address is too short or omitted altogether, then apply the Metrum to the petition. Additional Flexes may be added in the middle for longer Collects.[^6] If the text is pointed, the Dot **<Red text="·"/>** indicates when to leave the reciting note and enter the Metrum or the Flex.

**Example: Collect for Peace at Matins**[^7]
...
[^3]: *Saint Dunstan's Psalter*, 233
[^4]: *Saint Dunstan's Psalter*, xvi
[^5]: *Saint Dunstan's Psalter*, 234
[^6]: *Saint Dunstan's Psalter*, 281–282, This method of chanting the Collect is from as early as the 15th century.
[^7]: *Saint Dunstan's Psalter*, 283
