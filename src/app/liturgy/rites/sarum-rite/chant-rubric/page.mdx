...
The **Metrum** is applied to the **end of the address** and the **doxology**, and the **Flex** is applied to the **end of the petition** and the **oblation**. In other words, you open and close with the Metrum, and the Flex goes in the middle. In cases where the address is shortened or omitted, the Metrum is used in place of the Flex. For longer Collects, it is up the discretion of the Officiant to add Flexes in the middle where natural breaks occur.[^6]
