...
The [Intonation](/liturgy/rites/chant-rubric-sarum-rite#accents) is sung by the [Precentor](/glossary/liturgical-terms#precentor), and the rest of the psalm is is sung <Definition lang="english" anchor="antiphonal" text="antiphonally" />, alternating between the Precentor and the congregation.[^4]
...
|  \V Here endeth the first lesson.[^5]
</Poetry>
...
An optional third lesson from the Church Fathers or the lives of the saints may be added.[^6]
...
[^4]: *Saint Dunstan's Psalter*, 234
[^5]: *Saint Dunstan's Psalter*, 247
[^6]: *Saint Dunstan's Psalter*, 238
