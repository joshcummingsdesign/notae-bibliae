...
From the Latin *Quatuor tempora* (“four periods”). In German it became *Quatember*, and in English, simply "Ember". Ember Days are the quarterly periods of prayer and fasting on Wednesday, Friday, and Saturday—the Church's traditional fast days—following St. Lucy’s Day (winter), the First Sunday of Lent (spring), Pentecost (summer), and Holy Cross Day (fall).

Ember Days are days of thanksgiving for the four seasons of the year. Through fasting and abstinence, they teach us to use God’s gifts of nature in moderation, and through almsgiving, to assist the needy. As the fast culminates on Ember Saturdays, these days have traditionally been used for ordination.
...
The <Definition lang="latin" anchor="rogatio" text="Rogation Days" /> are the three days before Ascension Day. They originated in the 5th century as a means of prayer and fasting to protect the natural environment. They also help to prepare our hearts and minds for the celebration of Christ's Ascension. In the Anglican tradition, these are the days on which the Litany from the *Book of Common Prayer* is recited as an act of intercession. Processions, prayer, fasting, and the blessing of crops are common features of the Rogation Days.
