...
The General Roman Calendar (GRC) is the official liturgical calendar of the Roman Catholic Church. The term most commonly refers to the post–Vatican II revision promulgated in 1969, which simplified the calendar of saints and revised elements of the structure of the liturgical year. This calendar, together with the *<Definition lang="latin" anchor="ordo-lectionum-missae" text="Ordo Lectionum Missae" />*—the post-Vatican II lectionary—influenced a number of ecumenical liturgical initiatives, most notably the Revised Common Lectionary. Many churches have regarded its basic ordering of seasons and feasts as a coherent and historically grounded framework for the Christian year.
