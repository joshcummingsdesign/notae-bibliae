...
The collect is a formal liturgical prayer that "collects" the intentions of the people into a single prayer addressed to God. It typically involves a petition for peace, grace, or aid against perils. The collect has four parts: the address ("Almighty God..."), the petition ("Grant us that..."), the oblation ("So that we may..."), and the doxology ("Through the same Jesus Christ our Lord. Amen.").
...
The daily prayer <Definition lang="latin" anchor="officium" text="offices" /> of [Matins](#matins) and [Evensong](#evensong) as defined in the *Book of Common Prayer*.
...
From the Latin <Definition lang="latin" anchor="octavus" text="octavus" />, which means "eighth". An octave is the week, or eight-day period (inclusive counting), during which a major feast is celebrated. The octaves throughout the year include Christmas, Epiphany, Easter, Ascension, and Pentecost.
