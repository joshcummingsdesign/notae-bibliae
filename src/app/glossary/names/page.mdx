...
The Hebrew name *Yôḥānān* (יוֹחָנָן) means "the Lord is gracious". The Greek transliteration of the name is *Iōánnēs* (Ἰωάννης). The "es" was added to make it nominative. The Latinized version is *Iōhannēs*. In English it became John.

## Jonathan

The Hebrew name *Yehonatán* (יְהוֹנָתָן) means "the Lord has given". In English this became Jonathan.
