export const metadata = {
  ...
  description: "TODO",
  date: "2025-04-02",
  categories: ["Augustine", "Church History", "Liturgy", "Luther", "New Testament", "Sacraments"],
};
...
>
> <cite>Luther, *The Babylonian Captivity of the Church*[^4]</cite>
...
[^3]: Martin Luther, [*The Babylonian Captivity of the Church*](https://www.onthewing.org/user/Luther%20-%20Babylonian%20Captivity.pdf), trans. A. T. W. Steinhäuser, in *Works of Martin Luther: With Introductions and Notes*, vol. 2 (Philadelphia: A. J. Holman Company, 1915), 291–292
