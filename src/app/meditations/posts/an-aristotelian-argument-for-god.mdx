export const metadata = {
  ...
  description: "The argument from causality, showing how final and efficient causes point to a first cause—God as the unmoved mover and creation as the ultimate purpose—along with implications and common objections.",
  date: "2022-01-16",
