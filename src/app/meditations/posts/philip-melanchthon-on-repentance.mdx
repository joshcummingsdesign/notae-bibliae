export const metadata = {
  ...
  description: "In the 1530 Apology of the Augsburg Confession, Philip Melanchthon articulated the Lutheran understanding of repentance, which the Lutherans saw as a process involving contrition and faith, leading to assurance of forgiveness in Christ.",
  date: "2025-08-20",
  categories: ["Luther", "Repentance", "Theology"],
};
