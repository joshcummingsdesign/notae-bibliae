export const metadata = {
  ...
  description: "A study on the meaning of biblical numbers and their deep symbolism in Scripture. Discover how they represent themes of completion, authority, unrest, rest, new life, order, and spiritual leadership throughout the Bible.",
  date: "2023-12-20",
  categories: ["Bible"],
};
...
- The saints are said to reign with Christ for a **thousand years** (Rev. 20:4).

## 12 — Elders & God's People

- [St. Augustine](/people/saints/latin-fathers/augustine-of-hippo) points out that multiplying the two parts of the holy number seven gives you twelve (4 x 3 = 12).
- There were **12 Tribes of Israel** (Gen. 49:28).
- There were **12 Apostles** (Matt. 10:1).
- There are **24 books** of the Law and the Prophets.
- There were **24 divisions of priests** serving God in the temple (1 Chron. 24:18-19).
- John sees **144,000 of Israel** sealed in his vision, that is, **12,000 from each of the 12 Tribes of Israel** (Rev. 7:4-8).
