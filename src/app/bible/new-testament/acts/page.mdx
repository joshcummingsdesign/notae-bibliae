...
The church in Antioch in the Holy Spirit sends Barnabas and Paul on the first mission into Asia Minor (modern Turkey). They go to **Cyprus** (Salamis and Paphos), **Lycia** (Perga), **Galatia** (Antioch, Iconium, Lystra, and Derbe), and then they return and go from Lycia (Attalia) back to Jerusalem.
